...
// http://javascript-source.com
//***********************************************
jQuery("#wowslider-container1").wowSlider({effect:"stack",prev:"",next:"",duration:10*100,delay:50*100,width:1125,height:500,autoPlay:true,playPause:false,stopOnHover:true,loop:false,bullets:1,caption:false,captionEffect:"move",controls:true,onBeforeStep:0,images:0});